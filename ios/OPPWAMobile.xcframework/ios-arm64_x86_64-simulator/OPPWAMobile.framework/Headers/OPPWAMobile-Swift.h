...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull CASH_UP_UNKNOWN_TRANSACTION_STATE;)
+ (NSString * _Nonnull)CASH_UP_UNKNOWN_TRANSACTION_STATE SWIFT_WARN_UNUSED_RESULT;
@end
